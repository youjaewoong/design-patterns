...
import me.easytodo.designpatterns._02_structural_patterns._06_adapter._02_after.security.LoginHandler;
 ...
 * 단점
 *  - 새 클래스가 생겨 복잡도가 증가할 수 있다. 경우에 따라서는 기존 코드가 해당 인터페이스를 
 *    구현하도록 수정하는 것이 좋은 선택이 될 수도 있다.
 */ 
public class App {
    ...
    public static void main(String[] args) {
        ...
        String login = loginHandler.login("jaewoong", "jaewoong");
